...
// This code runs the server which listens for requests from the rest of the application. Nothing works without the server running.
// The server is the main coordinator of the application. Must run first.
